...
function mapJob(docSnap) {
  ...
  return {
    ...
    paperWidth: Number(data.paperWidth) || Number(documents[0]?.paperWidth) || 0,
    paperHeight: Number(data.paperHeight) || Number(documents[0]?.paperHeight) || 0,
    paperUnit: data.paperUnit || documents[0]?.paperUnit || 'in',
